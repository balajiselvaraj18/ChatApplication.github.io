...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppChatChatBoxChatBoxComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSharedFirstCharFirstCharComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div class=\"crop\" [style.color]=\"userColor ? userColor :'white'\" [style.background]=\"userBg ? userBg :'blue'\">\n    {{firstChar}}\n  </div>";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./node_modules/@angular/platform-browser/fesm2015/animations.js"); //routing 
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__["BrowserAnimationsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_10__["ToastrModule"].forRoot(), _chat_chat_module__WEBPACK_IMPORTED_MODULE_6__["ChatModule"], _user_user_module__WEBPACK_IMPORTED_MODULE_5__["UserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot([{
        path: 'login',
  ...
  function srcAppAppServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var rxjs_add_operator_toPromise__WEBPACK_IMPORTED_MODULE_6___default =
    /*#__PURE__*/
    __webpack_require__.n(rxjs_add_operator_toPromise__WEBPACK_IMPORTED_MODULE_6__);
    /* harmony import */
    ...
    function () {
      ...
      _createClass(AppService, [{
        ...
        value: function signupFunction(data) {
          var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]().set('firstName', data.firstName).set('lastName', data.lastName).set('mobile', data.mobile).set('email', data.email).set('password', data.password).set('apiKey', data.apiKey);
        ...
        value: function signinFunction(data) {
          var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]().set('email', data.email).set('password', data.password);
        ...
        value: function logout() {
          var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]().set('authToken', this.cookieService.get('authtoken'));
    ...
    AppService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], AppService);
    /***/
  },
  ...
  /***/
  function srcAppChatChatBoxChatBoxComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppChatChatBoxChatBoxComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function ChatBoxComponent(AppService, SocketService, router, toastr, vcr, Cookie) {
        var _this = this;
        ...
        this.checkStatus = function () {
          if (_this.Cookie.get('authtoken') === undefined || _this.Cookie.get('authtoken') === '' || _this.Cookie.get('authtoken') === null) {
        ...
        this.getPreviousChatWithAUser = function () {
          ...
          _this.SocketService.getChat(_this.userInfo.userId, _this.receiverId, _this.pageValue * 10).subscribe(function (apiResponse) {
        ...
        this.userSelectedToChat = function (id, name) {
          ...
          _this.Cookie.set('receiverId', id);

          _this.Cookie.set('receiverName', name);
        ...
        this.sendMessage = function () {
          if (_this.messageText) {
            var chatMsgObject = {
              ...
              receiverName: _this.Cookie.get('receiverName'),
              receiverId: _this.Cookie.get('receiverId'),
        ...
        this.getMessageFromAUser = function () {
          _this.SocketService.chatByUserId(_this.userInfo.userId).subscribe(function (data) {
            _this.receiverId == data.senderId ? _this.messageList.push(data) : '';

            _this.toastr.success("".concat(data.senderName, " says : ").concat(data.message));
        ...
        this.logout = function () {
          _this.AppService.logout().subscribe(function (apiResponse) {
            if (apiResponse.status === 200) {
              ...
              _this.Cookie["delete"]('authtoken');

              _this.Cookie["delete"]('receiverId');

              _this.Cookie["delete"]('receiverName');
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('scrollMe', {
      read: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]
    })], ChatBoxComponent.prototype, "scrollMe", void 0);
    ChatBoxComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-chat-box',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./chat-box.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/chat/chat-box/chat-box.component.html"))["default"],
      providers: [_socket_service__WEBPACK_IMPORTED_MODULE_2__["SocketService"]],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./chat-box.component.css */
      "./src/app/chat/chat-box/chat-box.component.css"))["default"]]
    })], ChatBoxComponent);
    /***/
  },
  ...
  function srcAppChatChatModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_pipe_remove_special_char_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./../shared/pipe/remove-special-char.pipe */
    ...
    ChatModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrModule"].forRoot(), _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild([{
        path: 'chat',
        component: _chat_box_chat_box_component__WEBPACK_IMPORTED_MODULE_3__["ChatBoxComponent"]
  ...
  /***/
  function srcAppSharedFirstCharFirstCharComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppSharedFirstCharFirstCharComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], FirstCharComponent.prototype, "userName", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], FirstCharComponent.prototype, "userBg", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], FirstCharComponent.prototype, "userColor", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], FirstCharComponent.prototype, "userNameAppear", void 0);
    FirstCharComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'first-char',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./first-char.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/first-char/first-char.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./first-char.component.css */
      "./src/app/shared/first-char/first-char.component.css"))["default"]]
    })], FirstCharComponent);
    /***/
  },
  ...
  /***/
  function srcAppSharedPipeRemoveSpecialCharPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RemoveSpecialCharPipe", function () {
    ...
    var RemoveSpecialCharPipe =
    /*#__PURE__*/
    function () {
      function RemoveSpecialCharPipe() {
        _classCallCheck(this, RemoveSpecialCharPipe);
      }

      _createClass(RemoveSpecialCharPipe, [{
        key: "transform",
    ...
    RemoveSpecialCharPipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
  ...
  function srcAppSharedSharedModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _first_char_first_char_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./first-char/first-char.component */
    "./src/app/shared/first-char/first-char.component.ts");
    ...
    SharedModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      exports: [_user_details_user_details_component__WEBPACK_IMPORTED_MODULE_3__["UserDetailsComponent"], _first_char_first_char_component__WEBPACK_IMPORTED_MODULE_5__["FirstCharComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"]]
    })], SharedModule);
    /***/
  },
  ...
  function srcAppSharedUserDetailsUserDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], UserDetailsComponent.prototype, "userFirstName", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], UserDetailsComponent.prototype, "userLastName", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], UserDetailsComponent.prototype, "userStatus", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], UserDetailsComponent.prototype, "messageRead", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], UserDetailsComponent.prototype, "userNameAppear", void 0);
  ...
  function srcAppSocketServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var rxjs_add_operator_do__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! rxjs/add/operator/do */
    "./node_modules/rxjs-compat/_esm2015/add/operator/do.js");
    /* harmony import */
    ...
    var rxjs_add_operator_toPromise__WEBPACK_IMPORTED_MODULE_7___default =
    /*#__PURE__*/
    __webpack_require__.n(rxjs_add_operator_toPromise__WEBPACK_IMPORTED_MODULE_7__);
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function SocketService(http, Cookie) {
        var _this2 = this;
        ...
        this.http = http;
        this.Cookie = Cookie;
        this.url = 'https://chatapi.edwisor.com'; // events to be listened 
        ...
        this.onlineUserList = function () {
          return rxjs_Observable__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(function (observer) {
            _this2.socket.on("online-user-list", function (userList) {
        ...
        this.markChatAsSeen = function (userDetails) {
          _this2.socket.emit('mark-chat-as-seen', userDetails);
        }; // end markChatAsSeen
        ...
        this.SendChatMessage = function (chatMsgObject) {
          _this2.socket.emit('chat-msg', chatMsgObject);
        }; // end getChatMessage
      ...
      _createClass(SocketService, [{
        key: "getChat",
        value: function getChat(senderId, receiverId, skip) {
          return this.http.get("".concat(this.url, "/api/v1/chat/get/for/user?senderId=").concat(senderId, "&receiverId=").concat(receiverId, "&skip=").concat(skip, "&authToken=").concat(this.Cookie.get('authtoken')))["do"](function (data) {
            return console.log('Data Received');
    ...
    SocketService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], SocketService);
    /***/
  },
  ...
  function srcAppUserLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LoginComponent(appService, router, toastr, vcr, Cookie) {
        var _this3 = this;
        ...
        this.goToSignUp = function () {
          _this3.router.navigate(['/sign-up']);
        }; // end goToSignUp


        this.signinFunction = function () {
          if (!_this3.email) {
            _this3.toastr.warning('enter email');
          } else if (!_this3.password) {
            _this3.toastr.warning('enter password');
          } else {
            var data = {
              email: _this3.email,
            ...
            _this3.appService.signinFunction(data).subscribe(function (apiResponse) {
              if (apiResponse.status === 200) {
                console.log(apiResponse);

                _this3.Cookie.set('authtoken', apiResponse.data.authToken);

                _this3.Cookie.set('receiverId', apiResponse.data.userDetails.userId);

                _this3.Cookie.set('receiverName', apiResponse.data.userDetails.firstName + ' ' + apiResponse.data.userDetails.lastName);

                _this3.appService.setUserInfoInLocalStorage(apiResponse.data.userDetails);
    ...
    function () {
      function SignupComponent(appService, router, toastr, vcr) {
        ...
        this.signupFunction = function () {
          if (!_this4.firstName) {
            _this4.toastr.warning('enter first name');
          } else if (!_this4.lastName) {
            _this4.toastr.warning('enter last name');
          } else if (!_this4.mobile) {
            _this4.toastr.warning('enter mobile');
          } else if (!_this4.email) {
            _this4.toastr.warning('enter email');
          } else if (!_this4.password) {
            _this4.toastr.warning('enter password');
          } else if (!_this4.apiKey) {
            _this4.toastr.warning('Enter your API key');
          } else {
            var data = {
              firstName: _this4.firstName,
              lastName: _this4.lastName,
              mobile: _this4.mobile,
              email: _this4.email,
              password: _this4.password,
              apiKey: _this4.apiKey
            };
            console.log(data);

            _this4.appService.signupFunction(data).subscribe(function (apiResponse) {
              console.log(apiResponse);

              if (apiResponse.status === 200) {
                _this4.toastr.success('Signup successful');
              ...
              _this4.toastr.error('some error occured');
            });
          } // end condition
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\SBalaji1\Desktop\Edwisor\chat-application\src\main.ts */
    "./src/main.ts");
    /***/
  },
